# Creación de un arbol binario
def ArbolBinario(r):
    return [r, [], []]

# Insertar un hijo Izquierdo
...
asignarValorRaiz(1,9)
print(r)
insertarIzquierdo(1,11)
print(r)
print(obtenerHijoIzquierdo(obtenerHijoDerecho(r))) 
